...
const drawFrame = (time) => {
  clear();
  drawFilledCircle((time / 10) % width, height / 1.6, 17, 'black');
  
  drawFallingRect(width / 2, time);
};
...
const drawRect = (x1, y1, x2, y2, x3, y3, color, width = 1) => {
